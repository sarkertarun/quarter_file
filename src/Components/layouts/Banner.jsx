  ...
  return (
    ...
    <section className='bg-[#F2F6F7] '>
        ...
        <Container className="max-w-[1174px] py-64">
            ...
            <Paragraph text="Lorem ipsum dolor sit amet, consectetur adipisicing" className="text-base font-Nunito text-[#5C727D]  pt-6"/>
            ...
            <div className="bg-white max-w-container pt-12 pb-10 pl-[30px] pr-[24px]  rounded-[5px] shadow-md absolute -bottom-[460px]">
